...
public class ZhuanFaPopupWindowDuoFa extends PopupWindow {
    ...
    public ZhuanFaPopupWindowDuoFa(Context context, ArrayList<UserInfo> users, String strUserID, String strUserDomainCode,
