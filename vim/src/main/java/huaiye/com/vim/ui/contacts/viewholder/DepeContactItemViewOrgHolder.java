...
public class DepeContactItemViewOrgHolder extends LiteViewHolder {
    ...
    public DepeContactItemViewOrgHolder(Context context, View view, View.OnClickListener ocl) {
