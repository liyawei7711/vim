...
public class DeptUserSelectedItemViewHolder extends LiteViewHolder {
    ...
    public DeptUserSelectedItemViewHolder(Context context, View view, View.OnClickListener ocl) {
