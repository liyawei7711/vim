package huaiye.com.vim.ui.setting.adapter;
...
public class SetLianXiRenListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SetLianXiRenListAdapter(Context context) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new CustomViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_user_detail_user_jinji, parent, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (TYPE_ADD.equals(msg.strUserID)) {
            ...
            viewHolder.iv_del.setVisibility(msg.canDel ? View.VISIBLE : View.GONE);
