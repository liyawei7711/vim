...
public class FragmentAllMeetings extends AppBaseFragment {
        ...
        adapter = new LiteBaseAdapter<>(getContext(),
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setClass(getActivity(), MeetControlActivity.class);
    ...
    void refreshDatas(final boolean isRef) {
        ...
        ModelApis.Meet().requesAllMeets(index, et_key.getText().toString(), start_time, end_time,
