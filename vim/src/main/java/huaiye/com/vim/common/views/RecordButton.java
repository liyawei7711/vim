...
public class RecordButton extends Button {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (tempNowY - startY < CANCLE_LENGTH) {
                    mTitleTv.setText(getContext().getString(R.string.releasing_finger_to_cancal_send));
                } else {
                    mTitleTv.setText(getContext().getString(R.string.finger_up_to_cancal_send));
                }
                break;
    ...
    private void finishRecord() {
        ...
        if (finishedListener != null)
            finishedListener.onFinishedRecord(mFilePath, (int) (System.currentTimeMillis() - mStartTime) / 1000);
        mFilePath = null;
    }
...
//                int x = new Random().nextInt(1000);
                int x = (int) JniIntf.GetSystemProperty(JniIntf.SYSTEM_PROPERTY_AUDIO_AMPLITUDE) * 100;
                if (x != 0) {
